...
class ManagerSolo(Manager.Manager):
    ...
    def utilities_gs(self):
        ...
        li_extra_options = (
            ...
            sep,
            ("position", _("Board editor"), Iconos.Datos(), Util.shortcut_menu_primary("S")),
            sep,
            ("initial", _("Basic position"), Iconos.Board(), Util.shortcut_menu_primary("B")),
            sep,
            ("opening", _("Opening"), Iconos.Opening()),
            sep,
            ("pasteposicion", _("Paste FEN position"), Iconos.Pegar16(), Util.shortcut_menu_primary("V")),
            sep,
            ("leerpgn", _("Read PGN file"), Iconos.PGN_Importar()),
            sep,
            ("pastepgn", _("Paste PGN"), Iconos.Pegar16(), Util.shortcut_menu_primary("V")),
            sep,
